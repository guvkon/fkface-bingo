...
var $author$project$Main$choices = _List_fromArray(
	['Night time shades', 'Double fisting', 'Separated at the crosswalk', 'Dumb hat', 'Loser board', 'Skate board', 'Fanny pack', 'Matching outfit', 'Guy on guy scooter', 'Dead Parrot Head', 'Crosswalk coward', 'Shirtless dude', 'Memaw', 'Kid out too late', 'Ghost tour bus / Street train', 'Trycicle', 'Pink taxi', 'Bouncer bounces', 'Drop something', 'Drop/spill food/drink', 'Litterbug', 'Jeans in flip-flops', 'Mullet', 'Bachelorette party', 'Go cart', 'Luxury car', 'Drunk walk', 'Wheel chair', 'Camera shy', 'Camera acknowledge', 'Bandage dude', 'Pickup / Dropoff', 'Dancing', 'Twerking', 'Sitting on the street', 'Chug', 'Hug', 'Aggressive honking', 'Trip', 'Someone yells for someone to wait up', 'Nose pick', 'Beach goth', 'Yawning', 'Trying to get into a wrong car', 'Formal attire', 'Hoofin it', 'Offensive T-shirt', 'Handshake', 'Couple fighting / regular fight', 'Cop car / ambulance / fire truck', 'Crying', 'Sucking on a chili dog', 'High five']);
